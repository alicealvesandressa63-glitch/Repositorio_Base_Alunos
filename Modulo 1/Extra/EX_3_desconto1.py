...
porcentagem = float(input('Qual o valor da poercentagem que o valor terá? '))
valor_desconto = float(preco*(porcentagem/100))
# print('o produto que custa R$',preco,'terá',valor_desconto,'de desconto. ')
print(f'o produto que custa R${preco} terá {valor_desconto} de desconto.')